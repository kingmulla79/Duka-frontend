...
const Profile: FC<Props> = ({ user }) => {
  ...
  return (
    <div className="w-[85%] flex mx-auto">
      <div
        className={`w-[60px] 800px:w-[310px] h-[450px] dark:bg-slate-600 bg-white bg-opacity-90 border dark:border-slate-800 border-[#e6e5e51d] rounded-[5px] shadow-xl dark:shadow-sm mt-[80px] mb-[80px] sticky ${
