...
const DashboardHeader: FC<Props> = ({ open, setOpen }) => {
  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-2 right-0">
      <ThemeSwitcher />
      <div
      ...
      {open && (
        <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-1000 rounded block">
            ...
            notifications.map((item: any) => (
              <div className="dark:bg-[#dfe2e8] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f] z-1000">
                <div className="w-full flex items-center justify-between p-2">
                  ...
                  <p
                    className="text-black  cursor-pointer bg-[#3a9e49] rounded px-1"
